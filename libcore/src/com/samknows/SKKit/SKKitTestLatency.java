...
//        }
    ...
    Thread latencyThread = new Thread() {
      ...
      public void run() {
        ...
        Log.d("IHT", "START Running Latency test for milliseconds=" + mTestDescriptor.mMaxTimeSeconds * 1000.0);
        ...
        Log.d("IHT", "STOPPED Running Latency test for milliseconds=" + actualTimeTakenMilli + ", completed after " + actualTimeTakenMilli);
