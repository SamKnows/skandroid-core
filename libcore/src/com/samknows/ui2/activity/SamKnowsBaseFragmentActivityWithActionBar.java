...
public class SamKnowsBaseFragmentActivityWithActionBar extends ActionBarActivity {

  static final String TAG = "SamKnowsBaseFragmentAct";

  public SamKnowsBaseFragmentActivityWithActionBar() {
      ...
      new AlertDialog.Builder(this)
          ...
          .setPositiveButton(SKConstants.RStringYes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
              ...
              // root task!
              SamKnowsBaseFragmentActivityWithActionBar.this.finish();
